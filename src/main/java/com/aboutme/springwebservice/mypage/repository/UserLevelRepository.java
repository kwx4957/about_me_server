...
//    ArrayList<UserLevel> findAllByUserIdOrderByColor(long userId);
    ...
    @Query(value = "SELECT * FROM User_Level WHERE user_id = :userId order by experience desc", nativeQuery = true)
    ArrayList<UserLevel> getOrderingByUserId(@Param(value="userId") long userId);
